 ...
 */
import type { Codecs } from "gel/dist/codecs/codecs";
import type { ConnectArgumentsParser, ConnectConfig, ResolvedConnectConfigReadonly } from "gel/dist/conUtils";
import { type Executor, type QueryArgs, type SQLQueryArgs } from "gel/dist/ifaces";
import type { RetryOptions, SimpleConfig, SimpleRetryOptions, SimpleTransactionOptions, TransactionOptions, WarningHandler } from "gel/dist/options";
import { Options } from "gel/dist/options";
import type { BaseRawConnection } from "gel/dist/baseConn";
import type { ConnectWithTimeout } from "gel/dist/retry";
...
export declare class Client implements Executor {
    ...
    describe(query: string): Promise<{
        in: import("gel/dist/codecs/ifaces").ICodec;
        out: import("gel/dist/codecs/ifaces").ICodec;
        cardinality: import("gel/dist/reflection").Cardinality;
        capabilities: number;
    }>;
